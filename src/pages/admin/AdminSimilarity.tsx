  ...
  return (
    <AdminLayout title="Similarity Results">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground">Document comparison results with plagiarism level classification</p>
      </div>
      ...
      <div className="mb-6 flex flex-wrap gap-3">
        <div className="rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm">
          ...
          <span className="ml-2 text-emerald-600">{results.filter((r) => r.similarityPercent <= 20).length} documents</span>
        </div>
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-sm">
          ...
          <span className="ml-2 text-amber-600">{results.filter((r) => r.similarityPercent > 20 && r.similarityPercent <= 49).length} documents</span>
        </div>
        <div className="rounded-lg border border-red-200 bg-red-50 px-4 py-2 text-sm">
          ...
          <span className="ml-2 text-red-600">{results.filter((r) => r.similarityPercent >= 50).length} documents</span>
        </div>
      </div>
